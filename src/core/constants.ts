export const APP_NAME = 'Finance App V4';
...
export const TRADES_STORE = 'trades';
...
export const REENTRY_STORE = 'reentryPlans';
export const EXIT_STRATEGY_STORE = 'exitStrategies';
